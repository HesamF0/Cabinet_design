...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `ghymat` int NOT NULL,
  `explane` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
(' ملامینه', 'assets/mdf4.webp', 1, 1000000, 'متداول ترین و پرکاربردترین روکشی که بر روی ام دی اف خام کشیده میشود ملامینه است. با توجه به این که ملامینه بسیار پر طرفدار است، این متریال در رنگ ها و طرحهای متفاوتی به بازار عرضه شده است و از نظر تنوع بالاترین میزان تنوع را دارد'),
...
('rrrrrr', 'Hesam', 'mijisoj420@sigmazon.com', '2222', 0),
('rrrrrr', 'Hesam', 'mijisoj420@sigmazon.com', '2222', 0),
('Hesam', 'Hesam', 'fovala5319@orsbap.com', '1111', 0),
('Hesam', 'Hesam', 'fovala5319@orsbap.com', '1111', 0),
('Hesam', 'Hesam', 'fovala5319@orsbap.com', '1111', 0);
COMMIT;
